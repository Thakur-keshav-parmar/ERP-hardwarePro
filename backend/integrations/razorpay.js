/**
 * Inventory Management System – Razorpay + AWS Integration Override
...
window.startPaymentFlow = async function () {
    ...
    try {
        ...
        const options = {
            ...
            name: storeSettings.name || 'Inventory Management System',
...
console.log('%c✅ Inventory Management System Razorpay Integration Loaded', 'color:green;font-weight:bold;');